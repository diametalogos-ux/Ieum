 ...
 *   - 축하화환: 556 (10F94A) / 근조화환: 557 (10F886)
 *   - 쌀화환: 558 / 축하쌀화환: 590 / 근조쌀화환: 591
 *   - 꽃바구니·다발: 552 (10F2B1) / 관엽(화분): 561 (10F0B6)
 *   - 동양란: 559 (10FB84) / 서양란: 560 (10FD54) / 분재: 562 (10F93D)
 */
export const WREATH_CATEGORIES = {
  congrats: { id: 556, label: '축하화환', code: '10F94A' },
  condolence: { id: 557, label: '근조화환', code: '10F886' },
  foliage: { id: 561, label: '관엽', code: '10F0B6' },
  basket: { id: 552, label: '꽃바구니·꽃다발', code: '10F2B1' },
  oriental: { id: 559, label: '동양란', code: '10FB84' },
  western: { id: 560, label: '서양란', code: '10FD54' },
  bonsai: { id: 562, label: '분재', code: '10F93D' },
} as const
